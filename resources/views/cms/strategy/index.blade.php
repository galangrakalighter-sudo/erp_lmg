...
<div class="container-fluid mt-4">
    ...
    <div class="card shadow">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Strategi</h6>
            {{-- <a href="{{ route('create_strategy_jasa') }}" class="btn btn-sm btn-primary">
                Tambah
            </a> --}}
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('strategy_create', $activeProductCode) }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="editModal_{{ $item->id }}" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('strategy_edit', $item->id) }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="deleteModal_{{ $item->id }}" tabindex="-1">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="{{ route('strategy_delete', $item->id) }}" method="POST">
                    @csrf
                    {{-- HEADER --}}
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title">Hapus Strategi</h5>
