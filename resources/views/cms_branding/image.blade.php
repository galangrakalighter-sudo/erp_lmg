    {{-- MODAL TAMBAH --}}
    <div class="modal fade" id="tambahModalImage" tabindex="-1" role="dialog" aria-labelledby="tambahModalLabel" aria-hidden="true">
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="tambahModalLabel">
                        <i class="fas fa-chart-pie mr-2"></i> Tambah Brand Image {{ $produk->nama }}
                    </h5>
    ...
    @foreach ($image as $item)
        {{-- MODAL EDIT ANALISIS --}}
        <div class="modal fade" id="editModalImage_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel_{{ $item->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title" id="editModalLabel_{{ $item->id }}">
                            <i class="fas fa-edit mr-2"></i> Edit Brand Image: {{ $item->nama }}
                        </h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" value="{{ $item->nama_image }}" required>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="deleteModalImage_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel_{{ $item->id }}" aria-hidden="true">
                ...
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <form action="{{ route('image.destroy', $item->id) }}" method="POST">
                        ...
                        <div class="modal-body p-4 text-center">
                            ...
                            <p class="text-muted">
                                Data analisis untuk <strong>"{{ $item->nama }}"</strong> akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.
                            </p>
                        </div>
