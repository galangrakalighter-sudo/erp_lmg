    {{-- MODAL TAMBAH --}}
    <div class="modal fade" id="tambahModalAlat" tabindex="-1" role="dialog" aria-labelledby="tambahModalLabel" aria-hidden="true">
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="tambahModalLabel">
                        <i class="fas fa-chart-pie mr-2"></i> Tambah Alat Branding
                    </h5>
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <label class="font-weight-bold text-dark">Nama Alat</label>
    ...
    @foreach ($alat as $item)
        {{-- MODAL EDIT ANALISIS --}}
        <div class="modal fade" id="editModalAlat_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel_{{ $item->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title" id="editModalLabel_{{ $item->id }}">
                            <i class="fas fa-edit mr-2"></i> Edit Alat: {{ $item->nama_alat }}
                        </h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" value="{{ $item->nama_alat }}" required>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="deleteModalAlat_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel_{{ $item->id }}" aria-hidden="true">
                ...
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <form action="{{ route('alat.destroy', $item->id) }}" method="POST">
                        ...
                        <div class="modal-body p-4 text-center">
                            ...
                            <p class="text-muted">
                                Alat <strong>"{{ $item->nama_alat }}"</strong> akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.
                            </p>
                        </div>
