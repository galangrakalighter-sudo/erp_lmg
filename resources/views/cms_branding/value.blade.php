<div class="modal fade" id="tambahModalValue" tabindex="-1" role="dialog" aria-labelledby="tambahModalLabel" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="tambahModalLabel">
                    <i class="fas fa-chart-pie mr-2"></i> Tambah Brand Value
                </h5>
            ...
            <form action="{{ route('value.store') }}" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="alert alert-info py-2 mb-0 mt-2">
                        <small><i class="fas fa-info-circle mr-1"></i> Pastikan data yang dimasukkan sudah sesuai dengan dokumen analisis terbaru.</small>
                    </div>
                </div>
...
@foreach ($value as $item)
    {{-- MODAL EDIT ANALISIS --}}
    <div class="modal fade" id="editModalValue_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel_{{ $item->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-header bg-warning text-dark">
                    <h5 class="modal-title" id="editModalLabel_{{ $item->id }}">
                        <i class="fas fa-edit mr-2"></i> Edit Brand Value: {{ $item->nama }}
                    </h5>
                ...
                <form action="{{ route('value.update', $item->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" value="{{ $item->nama_value }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-warning py-2 mb-0 mt-2 border-0" style="opacity: 0.8;">
                            <small class="text-dark"><i class="fas fa-exclamation-triangle mr-1"></i> Perubahan data akan langsung memperbarui tampilan pada laporan analisis.</small>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="deleteModalValue_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel_{{ $item->id }}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0 shadow-lg">
                ...
                <form action="{{ route('value.destroy', $item->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body p-4 text-center">
                        ...
                        <p class="text-muted">
                            Brand Value <strong>"{{ $item->nama_value }}"</strong> akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.
                        </p>
                    </div>
