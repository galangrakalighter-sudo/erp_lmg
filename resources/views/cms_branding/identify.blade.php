    ...
    @foreach ($identify as $item)
        <div class="modal fade" id="editModalIdentify_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <form action="{{ route('identify.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2 text-center">
                                    ...
                                    <div class="preview-wrapper border rounded p-2 bg-light">
                                        ...
                                        <img id="preview-display-{{ $item->id }}" 
                                            src="{{ asset('storage/' . $item->identify) }}" 
                                            data-original="{{ asset('storage/' . $item->identify) }}"
                                            alt="Preview" 
        ...
        <div class="modal fade" id="hapusModalIdentify_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="hapusModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow">
                    ...
                    <form action="{{ route('identify.destroy', $item->id) }}" method="POST">
                        @csrf
