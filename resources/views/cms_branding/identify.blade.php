    {{-- MODAL TAMBAH --}}
    <div class="modal fade" id="tambahModalIdentify" tabindex="-1" role="dialog" aria-labelledby="tambahModalLabel" aria-hidden="true">
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="tambahModalLabel">
                        <i class="fas fa-image mr-2"></i> Tambah Identify
                    </h5>
                ...
                <form action="{{ route('identify.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="file" name="image" id="inputImage" class="form-control" accept="image/*" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-2 text-center">
                                <div id="previewContainer" style="display: none;">
                                    ...
                                    <img id="imagePreview" src="#" alt="Preview" class="img-fluid rounded shadow-sm border" style="max-height: 300px; width: auto;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer bg-light border-top-0">
                        ...
                        <button type="submit" class="btn btn-primary px-4 shadow-sm">
                            <i class="fas fa-save mr-1"></i> Simpan Identify
                        </button>
                    </div>
                </form>
            </div>
    ...
    @if($identify)
        <div class="modal fade" id="editModalIdentify_{{ $identify->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow-lg">

                    <div class="modal-header bg-warning text-white">
                        <h5 class="modal-title">
                            <i class="fas fa-edit mr-2"></i> Edit Identify
                        </h5>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <form action="{{ route('identify.update', $identify->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="file" 
                                            ...
                                            class="form-control" 
                                            accept="image/*" 
                                            onchange="previewEditImage(this, '{{ $identify->id }}')">
                                    </div>
                                ...
                                <div class="col-md-12 mb-2 text-center">
                                    ...
                                    <div class="preview-wrapper border rounded p-2 bg-light">
                                        ...
                                        <img id="preview-display-{{ $identify->id }}" 
                                            src="{{ asset('storage/' . $identify->identify) }}" 
                                            data-original="{{ asset('storage/' . $identify->identify) }}"
                                            alt="Preview" 
                        ...
                        <div class="modal-footer bg-light border-top-0">
                            ...
                            <button type="submit" class="btn btn-warning px-4 shadow-sm text-white">
                                <i class="fas fa-sync-alt mr-1"></i> Update Identify
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal fade" id="hapusModalIdentify_{{ $identify->id }}" tabindex="-1" role="dialog" aria-labelledby="hapusModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow">
                    ...
                    <form action="{{ route('identify.destroy', $identify->id) }}" method="POST">
                        @csrf

                        <div class="modal-body text-center p-4">
                            <p class="mb-3">Apakah Anda yakin ingin menghapus gambar identify ini?</p>
    ...
    @endif
    <script>
        document.getElementById('inputImage').onchange = function (evt) {
        ...
        function previewEditImage(input, id) {
            ...
            const preview = document.getElementById('preview-display-' + id);
