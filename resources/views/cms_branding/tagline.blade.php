    {{-- MODAL TAMBAH --}}
    <div class="modal fade" id="tambahModalTagline" tabindex="-1" role="dialog" aria-labelledby="tambahModalLabel" aria-hidden="true">
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="tambahModalLabel">
                        <i class="fas fa-chart-pie mr-2"></i> Tambah Tagline
                    </h5>
                ...
                <form action="{{ route('tagline.store') }}" method="POST">
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_tagline" class="form-control" required>
                                </div>
                            </div>

                            <div class="col-md-12 mb-3">
                                <label class="font-weight-bold text-dark">Hashtag</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-light"><i class="fas fa-edit text-primary"></i></span>
                                    </div>
                                    <input type="text" name="nama_hastagline" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-info py-2 mb-0 mt-2">
                            <small><i class="fas fa-info-circle mr-1"></i> Tidak perlu menambahkan "#" diawal inputan hashtag</small>
                        </div>
                    </div>
    ...
    @foreach ($tagline as $item)
        {{-- MODAL EDIT ANALISIS --}}
        <div class="modal fade" id="editModalTagline_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel_{{ $item->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title" id="editModalLabel_{{ $item->id }}">
                            <i class="fas fa-edit mr-2"></i> Edit Tagline: {{ $item->nama }}
                        </h5>
                    ...
                    <form action="{{ route('tagline.update', $item->id) }}" method="POST">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_tagline" class="form-control" value="{{ $item->nama_tagline }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_hastagline" class="form-control" value="{{ $item->nama_hashtagline }}" required>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="deleteModalTagline_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel_{{ $item->id }}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <form action="{{ route('tagline.destroy', $item->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="modal-body p-4 text-center">
                            ...
                            <p class="text-muted">
                                Brand Value <strong>"{{ $item->nama_tagline }}"</strong> akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.
                            </p>
                        </div>
