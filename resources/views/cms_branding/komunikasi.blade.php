    {{-- MODAL TAMBAH --}}
    <div class="modal fade" id="tambahModalKomunikasi" tabindex="-1" role="dialog" aria-labelledby="tambahModalLabel" aria-hidden="true">
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="tambahModalLabel">
                        <i class="fas fa-chart-pie mr-2"></i> Tambah Gaya Komunikasi
                    </h5>
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <label class="font-weight-bold text-dark">Gaya Bicara</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-light"><i class="fas fa-edit text-primary"></i></span>
                                    </div>
                                    <input type="text" name="gaya_bicara" class="form-control" required>
                                </div>
                            </div>

                            <div class="col-md-12 mb-3">
                                <label class="font-weight-bold text-dark">Gaya Bahasa</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-light"><i class="fas fa-edit text-primary"></i></span>
                                    </div>
                                    <input type="text" name="gaya_bahasa" class="form-control" required>
                                </div>
                            </div>
                        </div>
    ...
    @foreach ($komunikasi as $item)
        {{-- MODAL EDIT ANALISIS --}}
        <div class="modal fade" id="editModalKomunikasi_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel_{{ $item->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title" id="editModalLabel_{{ $item->id }}">
                            <i class="fas fa-edit mr-2"></i> Edit Gaya Komunikasi: {{ $item->nama }}
                        </h5>
                    ...
                    <form action="{{ route('komunikasi.update', $item->id) }}" method="POST">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="gaya_bicara" class="form-control" value="{{ $item->gaya_bicara }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="gaya_bahasa" class="form-control" value="{{ $item->gaya_bahasa }}" required>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="deleteModalKomunikasi_{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel_{{ $item->id }}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <form action="{{ route('komunikasi.destroy', $item->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="modal-body p-4 text-center">
                            ...
                            <p class="text-muted">
                                Brand Value <strong>"{{ $item->gaya_bahasa }}"</strong> akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.
                            </p>
                        </div>
